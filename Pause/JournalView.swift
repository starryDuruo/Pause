        ...
        NavigationStack {
            List {
                if savedTasks.isEmpty {
                    Spacer()
                    ContentUnavailableView("No Moments Yet", systemImage: "pencil.and.outline", description: Text("Complete a task to see your journey here."))
                    Spacer()
                } else {
        ...
        HStack(alignment: .top, spacing: 20) {
            ...
            VStack(spacing: 0) {
                ...
                Circle()
                    ...
                    .background(Circle().stroke(.blue.opacity(0.3), lineWidth: 4))
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                // The Drawing Image
                if let drawing = try? PKDrawing(data: task.drawingData) {
